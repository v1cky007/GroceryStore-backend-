...
import com.GroceryStore.Store.services.ProfileService;
import com.GroceryStore.Store.services.OrderItemService;
...
public class LoginController {
    ...
    public LoginController(LoginService loginService, ProfileService profileService, OrderItemService orderItemService) {
    ...
    public ResponseEntity<OrderItem> createOrderForLogin(@PathVariable int loginId, @RequestBody OrderItem orderItem) {
        Login login = loginService.getLoginById(loginId).orElse(null);
        if (login != null) {
    ...
    public ResponseEntity<List<OrderItem>> getOrderItemsByLoginId(@PathVariable int loginId) {
        List<OrderItem> orderItems = orderItemService.getOrderItemsByLoginId(loginId);
